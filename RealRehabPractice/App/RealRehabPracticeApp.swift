                    ...
                    WelcomeView()
                        .navigationDestination(for: Route.self) { route in
                            Group {
                                ...
                                case .calibrateDevice(let reps, let restSec, let lessonId, let lessonTitle, let sets, let setRestSec): CalibrateDeviceView(reps: reps, restSec: restSec, lessonId: lessonId, lessonTitle: lessonTitle, sets: sets, setRestSec: setRestSec)
                                ...
                                case .directionsView1(let reps, let restSec, let lessonId, let lessonTitle, let sets, let setRestSec): DirectionsView1(reps: reps, restSec: restSec, lessonId: lessonId, lessonTitle: lessonTitle, sets: sets, setRestSec: setRestSec)
                                case .directionsView2(let reps, let restSec, let lessonId, let lessonTitle, let sets, let setRestSec): DirectionsView2(reps: reps, restSec: restSec, lessonId: lessonId, lessonTitle: lessonTitle, sets: sets, setRestSec: setRestSec)
                                case .lesson(let reps, let restSec, let lessonId, let lessonTitle, let sets, let setRestSec): LessonView(reps: reps, restSec: restSec, lessonId: lessonId, lessonTitle: lessonTitle, sets: sets, setRestSec: setRestSec)
