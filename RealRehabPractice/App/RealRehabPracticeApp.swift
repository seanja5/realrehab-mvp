                    ...
                    WelcomeView()
                        .navigationDestination(for: Route.self) { route in
                            Group {
                                ...
                                case .calibrateDevice(let reps, let restSec, let lessonId, let lessonTitle, let sets, let setRestSec, let holdDurationSec): CalibrateDeviceView(reps: reps, restSec: restSec, lessonId: lessonId, lessonTitle: lessonTitle, sets: sets, setRestSec: setRestSec, holdDurationSec: holdDurationSec)
                                ...
                                case .directionsView1(let reps, let restSec, let lessonId, let lessonTitle, let sets, let setRestSec, let holdDurationSec): DirectionsView1(reps: reps, restSec: restSec, lessonId: lessonId, lessonTitle: lessonTitle, sets: sets, setRestSec: setRestSec, holdDurationSec: holdDurationSec)
                                case .directionsView2(let reps, let restSec, let lessonId, let lessonTitle, let sets, let setRestSec, let holdDurationSec): DirectionsView2(reps: reps, restSec: restSec, lessonId: lessonId, lessonTitle: lessonTitle, sets: sets, setRestSec: setRestSec, holdDurationSec: holdDurationSec)
