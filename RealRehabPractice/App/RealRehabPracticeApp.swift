                    ...
                    WelcomeView()
                        .navigationDestination(for: Route.self) { route in
                            Group {
                                ...
                                case .calibrateDevice(let reps, let restSec, let lessonId, let lessonTitle): CalibrateDeviceView(reps: reps, restSec: restSec, lessonId: lessonId, lessonTitle: lessonTitle)
                                ...
                                case .directionsView1(let reps, let restSec, let lessonId, let lessonTitle): DirectionsView1(reps: reps, restSec: restSec, lessonId: lessonId, lessonTitle: lessonTitle)
                                case .directionsView2(let reps, let restSec, let lessonId, let lessonTitle): DirectionsView2(reps: reps, restSec: restSec, lessonId: lessonId, lessonTitle: lessonTitle)
